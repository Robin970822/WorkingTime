...
目前，我们提供三种查看作息时间表数据的方式：

- 通过微信小程序 WorkInfo 查询特定的作息时间表记录。
...
微信小程序 WorkInfo（小程序码如上图)现提供本平台所有作息时间表数据的查询服务。您可根据小程序首页的提示，在搜索框中输入感兴趣的机构与岗位的信息。也可以通过小程序提交数据，我们会在审核之后展示。小程序将提供平台维护的相关作息时间表记录。

## 如何奉献自己的一份力

首先，我们对在项目开发和维护期间给我们提供帮助和建议的所有人士表示衷心地感谢！

如果您想向我们的平台分享您个人的作息时间表，请通过小程序 WorkInfo 或者官网 https://www.tutou.site 提交数据

## 重要链接

如您想和本平台的开发者和其他用户进行交流，可申请加入 QQ 群：516502728
